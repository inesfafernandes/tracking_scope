...
[under_100_not_moving_direct_command, under_100_moving_direct_command,above_100_not_moving_direct_command,above_100_moving_direct_command, velocity_filt_direct_command]=moving_calculator(x_trajectory,model_direct_command);
[under_100_not_moving_170_predicted, under_100_moving_170_predicted,above_100_not_moving_170_predicted,above_100_moving_170_predicted, velocity_filt_170_predicted]=moving_calculator(x_trajectory,MPC_T170_know_future);
[under_100_not_moving_250_predicted, under_100_moving_250_predicted, above_100_not_moving_250_predicted,above_100_moving_250_predicted, velocity_filt_250_predicted]=moving_calculator(x_trajectory,MPC_T250_know_future);
[under_100_not_moving_170_naive, under_100_moving_170_naive, above_100_not_moving_170_naive, above_100_moving_170_naive,  velocity_filt_170_naive]=moving_calculator(x_trajectory,MPC_T170_naive_model);
[under_100_not_moving_250_naive, under_100_moving_250_naive,  above_100_not_moving_250_naive, above_100_moving_250_naive, velocity_filt_250_naive]=moving_calculator(x_trajectory,MPC_T250_naive_model);

pie_direct_command_not_moving=[under_100_not_moving_direct_command above_100_not_moving_direct_command ];
pie_direct_command_moving=[under_100_moving_direct_command  above_100_moving_direct_command];
pie_170_predicted_not_moving=[under_100_not_moving_170_predicted  above_100_not_moving_170_predicted];
pie_170_predicted_moving=[under_100_moving_170_predicted  above_100_moving_170_predicted];
pie_250_predicted_not_moving=[under_100_not_moving_250_predicted above_100_not_moving_250_predicted ];
pie_250_predicted_moving=[under_100_moving_250_predicted  above_100_moving_250_predicted];
pie_170_naive_not_moving=[under_100_not_moving_170_naive  above_100_not_moving_170_naive];
pie_170_naive_moving=[under_100_moving_170_naive above_100_moving_170_naive ];
pie_250_naive_not_moving=[under_100_not_moving_250_naive  above_100_not_moving_250_naive];
pie_250_naive_moving=[under_100_moving_250_naive  above_100_moving_250_naive];


figure(1)
subplot(1,2,1)
labels = {'<50micro','>50micro'};
